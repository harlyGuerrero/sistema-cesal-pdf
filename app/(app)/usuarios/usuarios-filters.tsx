...
// Fase 29: mismo patrón de filtros en vivo que /activos (activos-filters.tsx)
// — debounce en el buscador, selects al toque, todo vía router.replace sin
// recarga completa.
  ...
  return (
    <div className="flex flex-col gap-3 sm:flex-row sm:flex-wrap sm:items-end">
      <div className="grid flex-1 grid-cols-1 gap-3 sm:grid-cols-3">
        ...
        <div className="space-y-1">
          <label className="truncate text-xs font-medium text-muted-foreground">Rol</label>
          <Select
            value={searchParams.get("rol") ?? "all"}
            onValueChange={(value) => applyParams({ rol: value as string })}
          >
